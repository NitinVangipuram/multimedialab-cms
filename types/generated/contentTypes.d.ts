...
export interface ApiTeamDescriptionTeamDescription extends Schema.SingleType {
  collectionName: 'team_descriptions';
  info: {
    singularName: 'team-description';
    pluralName: 'team-descriptions';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::team-description.team-description',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
